...
var WidgetMetadata = {
    ...
    modules: [
        ...
        {
            title: "🎞️ 影视榜单Lite",
            description: "豆瓣榜单 / 周更日历 / TMDB探索",
            functionName: "loadLiteHub",
            type: "video",
            cacheDuration: 1800,
            params: [
                {
                    name: "lite_source", title: "选择子列表", type: "enumeration", value: "douban",
                    enumOptions: [
                        { title: "🟢 豆瓣", value: "douban" },
                        { title: "🗓️ 周更", value: "calendar" },
                        { title: "🔵 TMDB", value: "tmdb" },
                        { title: "🔥 IMDb热榜", value: "imdb" }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    belongTo: { paramName: "lite_source", value: ["calendar"] },
                    enumOptions: [ { value: "today", title: "📺 今天更新" }, { value: "1", title: "🔹 周一 (Monday)" }, { value: "2", title: "🔹 周二 (Tuesday)" }, { value: "3", title: "🔹 周三 (Wednesday)" }, { value: "4", title: "🔹 周四 (Thursday)" }, { value: "5", title: "🔹 周五 (Friday)" }, { value: "6", title: "🔹 周六 (Saturday)" }, { value: "7", title: "🔹 周日 (Sunday)" } ]
                },
                {
                    name: "showType", title: "影视分类", type: "enumeration", value: "all",
                    belongTo: { paramName: "lite_source", value: ["calendar"] },
                    enumOptions: [ { value: "all", title: "综合影剧" }, { value: "tv", title: "📺 纯净剧集" }, { value: "movie", title: "🎬 院线电影" }, { value: "anime", title: "🌸 二次元动漫" }, { value: "show", title: "🎤 娱乐综艺" } ]
                },
                {
                    name: "tmdb_sort_by", title: "模式", type: "enumeration", value: "movie",
                    belongTo: { paramName: "lite_source", value: ["tmdb"] },
                    enumOptions: [ { value: "movie", title: "🎬 电影筛选" }, { value: "tv", title: "📺 剧集筛选" } ]
                },
                {
                    name: "genre", title: "类型", type: "enumeration", value: "",
                    belongTo: { paramName: "lite_source", value: ["tmdb"] },
                    enumOptions: [ { title: "全部", value: "" }, { title: "动作/冒险", value: "28" }, { title: "科幻/奇幻", value: "878" }, { title: "剧情", value: "18" }, { title: "喜剧", value: "35" }, { title: "动画", value: "16" }, { title: "悬疑/犯罪", value: "9648" }, { title: "恐怖/惊悚", value: "27" }, { title: "爱情", value: "10749" } ]
                },
                { name: "year", title: "年份", type: "input", description: "例如: 2024", value: "", belongTo: { paramName: "lite_source", value: ["tmdb"] } },
                {
                    name: "sortBy", title: "排序", type: "enumeration", value: "popularity.desc",
                    belongTo: { paramName: "lite_source", value: ["tmdb"] },
                    enumOptions: [ { title: "🔥 热度最高", value: "popularity.desc" }, { title: "⭐️ 评分最高", value: "vote_average.desc" }, { title: "🆕 最新上映", value: "primary_release_date.desc" } ]
                },
                { name: "imdb_sort_by", title: "榜单类型", type: "enumeration", value: "trending_week", belongTo: { paramName: "lite_source", value: ["imdb"] }, enumOptions: [
                    { title: "📅 本周热榜 (Trending Week)", value: "trending_week" }, { title: "🔥 今日热榜 (Trending Day)", value: "trending_day" }, { title: "🌊 流行趋势 (Popular)", value: "popular" }, { title: "💎 高分神作 (Top Rated)", value: "top_rated" }, { title: "🇨🇳 国产剧热度 (模拟云合)", value: "china_tv" }, { title: "🇨🇳 国产电影热度 (模拟)", value: "china_movie" }
                ] },
                { name: "imdb_mediaType", title: "范围 (仅全球榜有效)", type: "enumeration", value: "all", belongTo: { paramName: "imdb_sort_by", value: ["trending_week", "trending_day", "popular", "top_rated"] }, enumOptions: [
                    { title: "全部 (剧集+电影)", value: "all" }, { title: "电影", value: "movie" }, { title: "剧集", value: "tv" }
                ] },
...
// ================= 模块 1：全球探索发现 =================
        ...
        // ---------------- 大栏目 5：影剧风向标 (IMDb + 烂番茄 + Trakt + 豆瓣) ----------------
        {
            ...
            params: [
                {
                    name: "sort_by", title: "选择榜单", type: "enumeration", value: "imdb_trending_week",
                    enumOptions: [
                        { title: "🟡 IMDb · 本周热榜", value: "imdb_trending_week" },
                        { title: "🟡 IMDb · 今日热榜", value: "imdb_trending_day" },
                        { title: "🟡 IMDb · 流行趋势", value: "imdb_popular" },
                        { title: "🟡 IMDb · 高分神作", value: "imdb_top_rated" },
                        ...
                        { title: "🍅 烂番茄 · 院线热映", value: "rt_movies_theater" },
                        { title: "🍅 烂番茄 · 热门剧集", value: "rt_tv_popular" },
                        { title: "🟢 豆瓣 · 热门国产剧", value: "douban_tv_cn" },
                        { title: "🟢 豆瓣 · 热门电影", value: "douban_movie" },
                        { title: "🟢 豆瓣 · 热门美剧", value: "douban_tv_us" },
                        { title: "🔥 TMDB · 热门趋势", value: "tmdb_hot" }
                    ]
                },
                { name: "mediaType", title: "IMDb 范围", type: "enumeration", value: "all", enumOptions: [ { title: "全部 (剧集+电影)", value: "all" }, { title: "电影", value: "movie" }, { title: "剧集", value: "tv" } ] },
...
async function routeTrendsHub(params) {
    const mode = params.sort_by || "imdb_trending_week";
    const page = params.page || 1;
    if (mode.indexOf("imdb_") === 0) return await loadImdbList(mode.slice(5), params.mediaType || "all", page);
    if (mode.indexOf("trakt_") === 0) return await handleTraktList(mode.slice(6), params.traktType || "all", params.traktClientId || DEFAULT_TRAKT_ID, page);
    if (mode.indexOf("rt_") === 0) return await loadRottenTomatoesTrends(mode, page);
    if (mode.indexOf("douban_") === 0) {
        const key = mode.slice(7); const map = { tv_cn:["国产剧","tv"], movie:["热门","movie"], tv_us:["美剧","tv"] };
        const item = map[key] || map.tv_cn; return await fetchDoubanAndMap(item[0], item[1], page);
    }
    return await loadTmdbHotTrend({ mediaType: "all", region: "", page });
}
