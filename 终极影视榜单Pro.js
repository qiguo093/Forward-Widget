...
// ================= 模块 1：全球探索发现 =================
        ...
        {
            title: "🏷️ 高级类型榜单",
            functionName: "loadGlobalZoneGenreRank",
            type: "video", // 保留你需要的自适应排版
            cacheDuration: 3600,
            params: [
                {
...
async function loadGlobalZoneGenreRank(params = {}) {
    const page = parseInt(params.page) || 1;
    ...
    const genreId = ZONE_ADVANCED_GENRE_MAP[genre] ? ZONE_ADVANCED_GENRE_MAP[genre][mediaType] : "";
    const originCountry = ZONE_REGION_MAP[region] || "";
