WidgetMetadata = {
  ...
  globalParams: [
    ...
    { name: "serverName2", title: "源2名称", type: "input", value: "AlphaTV-Pro" },
    { name: "server2", title: "源2链接", type: "input", value: "http://nl.jc.cd/87654321" },
...
async function searchDanmu(params) { return await danmuSearch(params || {}); }
async function getDetailById(params) { return await danmuDetail(params || {}); }
async function getCommentsById(params) { return await danmuComments(params || {}); }
